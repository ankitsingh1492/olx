...
<html lang="en">
  ...
  <body id = "home">
       <div id="logo-top"> <a href="../home.php" id="logo"> <img src="../img/logo.png"> </a> </div> 
    <div id = "upload1">
    	<div id = "upload2">
    		<div id ="upl">
   ...
   <li >
	      ...
	      <a href="../home.php#space2" >Log in</a>
           ...
           <h2 > Submit Ad </h2>
    			...
    			<form action ="upload_ad.php" id="myForm2" method="POST">
              ...
              <form action="iupload.php" method="post" id = "myForm" enctype="multipart/form-data">
